...
<section class="liked-videos">
   ...
   <h1 class="heading">les likes videos</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">voir video</a>
