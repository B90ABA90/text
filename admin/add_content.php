...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <p>état de la vidéo <span>*</span></p>
      <select name="status" class="box" required>
      <option value="" sélectionné désactivé>-- sélectionnez le statut</option>
      ...
      <p>sélectionner la vignette <span>*</span></p>
      <input type="file" name="thumb" accept="image/*" required class="box">
      <p>sélectionner la vidéo <span>*</span></p>
      <input type="file" name="video" accept="video/*" required class="box">
      <input type="submit" value="upload video" name="envoie" class="btn">
   </form>
