...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">afficher le contenu</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">pas encore de contenu ajouté!</p>';
      }
   ?>
