...
if(isset($_POST['delete_playlist'])){
   ...
   $message[] = 'playlist deleted!';
      ...
      $message[] = 'liste de lecture déjà supprimée!';
   }
}
...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">afficher le contenut</a>
      </div>
   <?php
         }
      }else{
      ...
      echo '<p class="empty">veilleyt rechercher quelque chose!</p>';
   }
   ?>
...
<section class="playlists">
   ...
   <h1 class="heading">playlistes</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">mise à</a>
            <input type="submit" value="delete_playlist" class="delete-btn" onclick="return confirm('supprimer cette playlist ?');" name="supprimer">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">voir la playliste</a>
      </div>
      <?php
         } 
      }else{
         ...
         echo '<p class="empty">veillez rechercher quelque chose!</p>';
      }
      ?>
