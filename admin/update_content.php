...
<head>
   ...
   <title>Mettre à jour la vidéoo</title>
...
<h1 class="heading">mettre à jour le contenu</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>mettre à jour le statut <span>*</span></p>      <select name="status" class="box" required>
      ...
      <p>mettre à jour la liste de lecture</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--select liste de lecture</option>
         <?php
         ...
         <?php
            ...
            echo '<option value=""désactive> aucune liste de lecture créée pour le moment!</option>';
         }
         ?>
      </select>
      ...
      <input type="submit" value="update content" name="mise à jour" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">afficher le contenu</a>
   ...
   <?php
         ...
         echo '<p class="empty">! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
