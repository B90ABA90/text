...
<head>
   ...
   <title>afficher le contenu</title>
...
<section class="view-content">
   ...
   <?php
      ...
      echo '<p class="empty">pas encore de contenu ajouté ! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
   }
...
<section class="comments">
   ...
   <div class="show-comments">
      ...
      <?php
         ...
         echo '<p class="empty">pas encore de commentaires ajoutés!</p>';
      }
      ?>
      </div>
