...
if(isset($_POST['submit'])){
   ...
   if($select_tutor->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $message[] = 'nouveau tuteur inscrit! veuillez vous connecter maintenant';
      }
   }
      ...
      <div class="flex">
         <div class="col">
            ...
            <select name="profession" class="box" required>
               ...
               <option value="musician">mecanicien</option>
               <option value="biologist">biologist</option>
               <option value="teacher">professeur</option>
               <option value="engineer">Directeur</option>
               <option value="lawyer">surveillant</option>
               <option value="accountant">Daf</option>
               <option value="doctor">senceur</option>
               <option value="journalist">journalist</option>
               <option value="photographer">admistrateur</option>
            </select>
         ...
         <div class="col">
            ...
            <input type="password" name="cpass" placeholder="confirmer votre mot passe" maxlength="20" required class="box">
            <p>select pic <span>*</span></p>
            <input type="file" name="image" accept="image/*" required class="box">
         </div>
      </div>
      <p class="link">Vous avez déjà un compte? <a href="login.php">créer</a></p>
