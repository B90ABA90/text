...
<section class="playlists">
   ...
   <h1 class="heading">listes de lecture ajoutées</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">créer une nouvelle liste de lecture</h3>
         <a href="add_playlist.php" class="btn">ajouter une liste de lecture</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">afficher la liste de lecture</a>
      </div>
      <?php
         } 
      }else{
