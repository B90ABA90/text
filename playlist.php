   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>sauvegarder</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>sauvegarder la playliste</span></button>
            <?php
               }
            ?>
         </form>
      ...
      <?php
            ...
            echo '<p class="empty">cette playlist est introuvable!</p>';
         }  
      ?>
